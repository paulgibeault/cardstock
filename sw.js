 ...
 *
 *   1. Never serve or cache anything outside /cardstock/. The fetch
...
const GAME_ID = 'cardstock';                // must match Arcade.init({ gameId })
const SCOPE = `/${GAME_ID}/`;
