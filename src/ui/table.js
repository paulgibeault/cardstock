...
// src/players/roster.js, and THE OPPONENT ROW — the fit ladder, the seat plate,
// the view toggle, the edge fades, the height reserve and the counters and chips
// a plate wears — in src/ui/seatRow.js (#223). What is left here is the rest of
// the felt: piles, the hand, and the loop that turns a move into sound, motion
// and a save.
//
...
import {
  ...
  // The opponent row's own pure decisions are still over there for the same
  // reason (`normalizeSeatView`, `seatToShow` — see the section header at the
  // foot of session.js); src/ui/seatRow.js is what imports them now.
  //
  // And here for that same reason: "is this input a NEW gesture, or the one that
